...
public class ManageClientFrame {
    ...
    private ClientService clientService= Main.clientService;
    JPanel f = new JPanel();
    ...
    public ManageClientFrame() throws SQLException {
    ...
    public JPanel addClient() {
        ...
        panel2.setBackground(MainFrame.background);
        ...
        radio1.setFont(MainFrame.font2);
        radio1.setForeground(MainFrame.fontC);
        radio1.setBackground(MainFrame.background);
        group.add(radio1);
        radio1.setBounds(0, 70, 100, 30);

        JRadioButton radio2 = new JRadioButton("Student");
        radio2.setFont(MainFrame.font2);
        radio2.setForeground(MainFrame.fontC);
        radio2.setBackground(MainFrame.background);
        group.add(radio2);
        radio2.setBounds(120, 70, 100, 30);

        JRadioButton radio3 = new JRadioButton("Adult");
        radio3.setFont(MainFrame.font2);
        radio3.setForeground(MainFrame.fontC);
        radio3.setBackground(MainFrame.background);
        group.add(radio3);
        radio3.setBounds(240, 70, 100, 30);

        JRadioButton radio4 = new JRadioButton("Pensioner");
        radio4.setFont(MainFrame.font2);
        radio4.setForeground(MainFrame.fontC);
        radio4.setBackground(MainFrame.background);
        group.add(radio4);
        ...
        panel1.setBackground(MainFrame.background);
    ...
    public void typeOfClient(JRadioButton radio1, JRadioButton radio2, JRadioButton radio3, JRadioButton radio4, JPanel panel, JPanel panel1, JPanel panel2) {
        ...
        emailLabel.setFont(MainFrame.font2);
        emailLabel.setForeground(MainFrame.fontC);
        JTextField email = new JTextField();
        JLabel phoneLabel = new JLabel("Phone: ");
        phoneLabel.setFont(MainFrame.font2);
        phoneLabel.setForeground(MainFrame.fontC);
        JTextField phone = new JTextField();
        JLabel ageLabel = new JLabel("Age: ");
        ageLabel.setFont(MainFrame.font2);
        ageLabel.setForeground(MainFrame.fontC);
        JTextField age = new JTextField();
        JLabel noLegitLabel = new JLabel("No. legit: ");
        noLegitLabel.setFont(MainFrame.font2);
        noLegitLabel.setForeground(MainFrame.fontC);
